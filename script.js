...
window.closeRoutedex = () => document.getElementById('routedex-modal').style.display = 'none';
...
window.openRoutedex = function() {
    const modal = document.getElementById('routedex-modal');
    ...
    uniqueNames.forEach(pkName => {
        ...
        entry.className = 'routedex-item';

        entry.innerHTML = `
    <span class="${hasShiny ? 'routedex-owned' : 'routedex-missing'}">
        <img src="${ICONS.shiny}" class="icon-routedex-shiny">
    </span>

    <span class="${hasNormal ? 'routedex-owned' : 'routedex-missing'}">
        <img src="${ICONS.pokeball}" class="icon-routedex-ball">
    </span>
